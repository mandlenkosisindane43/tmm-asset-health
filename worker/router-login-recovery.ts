...
export default {
  async fetch(req:Request,env:Env,ctx:ExecutionContext){
    ...
    if(req.method==="POST"&&url.pathname==="/api/contractor/login")return fastLogin(req,env,ctx);
