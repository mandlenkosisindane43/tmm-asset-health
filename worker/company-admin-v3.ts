...
async function ensureSchema(env: CompanyAdminEnv) {
  ...
  schemaReady = (async () => {
    const statements = [
      `CREATE TABLE IF NOT EXISTS company_sites (id INTEGER PRIMARY KEY AUTOINCREMENT,company_id INTEGER NOT NULL,name TEXT NOT NULL,code TEXT,active INTEGER NOT NULL DEFAULT 1,created_at TEXT NOT NULL)`,
      `CREATE TABLE IF NOT EXISTS company_settings_v3 (company_id INTEGER PRIMARY KEY,contact_email TEXT,contact_phone TEXT,operating_hours REAL NOT NULL DEFAULT 24,daily_production_target REAL NOT NULL DEFAULT 0,availability_target REAL NOT NULL DEFAULT 90,default_site TEXT,updated_at TEXT NOT NULL)`,
      `CREATE TABLE IF NOT EXISTS alert_contacts_v3 (id INTEGER PRIMARY KEY AUTOINCREMENT,company_id INTEGER NOT NULL,name TEXT NOT NULL,email TEXT,phone TEXT,breakdown INTEGER NOT NULL DEFAULT 1,service_due INTEGER NOT NULL DEFAULT 1,missing_report INTEGER NOT NULL DEFAULT 1,po INTEGER NOT NULL DEFAULT 0,critical INTEGER NOT NULL DEFAULT 1,active INTEGER NOT NULL DEFAULT 1,created_at TEXT NOT NULL)`,
      `CREATE TABLE IF NOT EXISTS approvals_v3 (id INTEGER PRIMARY KEY AUTOINCREMENT,company_id INTEGER NOT NULL,approval_type TEXT NOT NULL,title TEXT NOT NULL,submitted_by TEXT,details TEXT,status TEXT NOT NULL DEFAULT 'pending',created_at TEXT NOT NULL,reviewed_at TEXT)`,
      `CREATE TABLE IF NOT EXISTS daily_reports_v3 (id INTEGER PRIMARY KEY AUTOINCREMENT,company_id INTEGER NOT NULL,report_date TEXT NOT NULL,site TEXT NOT NULL,fleet_number TEXT NOT NULL,activity TEXT NOT NULL DEFAULT 'operating',capture_basis TEXT NOT NULL,time_value REAL,time_unit TEXT,hour_meter_start REAL,hour_meter_end REAL,duration_hours REAL NOT NULL DEFAULT 0,tonnes REAL,fault_reason TEXT,breakdown_start TEXT,breakdown_end TEXT,severity TEXT NOT NULL DEFAULT 'medium',source_kind TEXT NOT NULL DEFAULT 'manual',source_file TEXT,created_by INTEGER NOT NULL,status TEXT NOT NULL DEFAULT 'saved',created_at TEXT NOT NULL)`,
      `CREATE TABLE IF NOT EXISTS report_history_v3 (id INTEGER PRIMARY KEY AUTOINCREMENT,company_id INTEGER NOT NULL,report_type TEXT NOT NULL,period_key TEXT NOT NULL,title TEXT NOT NULL,status TEXT NOT NULL DEFAULT 'published',published_by INTEGER NOT NULL,published_at TEXT NOT NULL,UNIQUE(company_id,report_type,period_key))`,
